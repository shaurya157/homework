...
class MetaCorgiPerkPackage
  ...
  #   str1 = "get_#{name}_info".to_sym
  #   str2 = "get_#{name}_happiness".to_sym
  #
  #   value1 = @shopping_list.send(str1, @package_id)
  #   value2 = @shopping_list.send(str2, @package_id)
  #   star = (value2 > 30 ? "*":"")
  #
  #   "#{star}#{name.capitalize}: #{value1}: #{value2} lick"
  # end
